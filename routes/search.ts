...
export function searchProducts () {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    // Use parameterized query to avoid SQL injection. Bind the criteria with wildcard
    // characters in a replacement parameter instead of interpolating directly into
    // the SQL string.
